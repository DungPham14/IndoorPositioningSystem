package com.example.cpu0131.sdk.osmdroid;
...
public class OpenStreetMapOverlay extends Activity {
    ...
    private IALocationListener mListener = new IALocationListenerSupport() {
        ...
        public void onLocationChanged(IALocation location) {
            ...
            Log.d(
                    TAG, "new location received with coordinates: "
    ...
    protected void onResume() {
        ...
        if (mOsmv == null) {
            ...
            mTilesOverlay = new TilesOverlay(
                    mProvider,
                    getBaseContext()
            );
            ...
            mLayout.addView(mOsmv, new LayoutParams(
        ...
        if (mLoadTarget == null) {
            mLoadTarget = new Target() {
                ...
                public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                    Log.d(
                            TAG,
                            "onBitmap loaded with dimensions: "
                                    + bitmap.getWidth()
                                    + "x"
                                    + bitmap.getHeight()
                    );
